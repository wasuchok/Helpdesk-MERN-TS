...
const TableHistoryReportByUser = () => {
    ...
    const FetchAllTicket = async (authtoken: string) => {
      const response = await axios.get(`${import.meta.env.VITE_API}/ticket/read_history_report_ticket_by_user`, {
        headers: {
          authtoken,
        },
      });
...
export default TableHistoryReportByUser