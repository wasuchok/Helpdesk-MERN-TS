...
const TableHistoryReportByTechnician = () => {
    ...
    const FetchAllTicket = async (authtoken: string) => {
      const response = await axios.get(`${import.meta.env.VITE_API}/ticket/read_history_report_ticket_by_technician`, {
        headers: {
          authtoken,
        },
      });
...
export default TableHistoryReportByTechnician